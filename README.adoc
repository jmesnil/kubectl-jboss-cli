...
$ kubectl jboss-cli -p my-app-77d65cb876-9p242
...
[source,shell]
----
$ kubectl jboss-cli -p my-app-77d65cb876-9p242 -- --command=':read-attribute\(name=product-version\)'
{
    "outcome" => "success",
    "result" => "25.0.1.Final"
}
...
[source,shell]
----
$ kubectl jboss-cli -l app.kubernetes.io/instance=my-app -- --commands=":read-attribute\(name=name\),:read-attribute\(name=uuid\)"
...
$ kubectl jboss-cli -l app.kubernetes.io/instance=my-app -f ./change-log-level.cli
----
